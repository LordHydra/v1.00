...
client.on("guildMemberAdd", async (member) => {
 ...
 //const activities_list = [
   // "Sunucuna Eklemeye Ne Dersin /davet", // Sadece Tırnak Yani " İşareti İçinde Yazmakta Olan Mesajları Değiştirin.
   // "Oy verirsen sevinirim /oy", // Sadece Tırnak Yani " İşareti İçinde Yazmakta Olan Mesajları Değiştirin.
   // "Komutlarımıza Bakmak için /yardım", // Sadece Tırnak Yani " İşareti İçinde Yazmakta Olan Mesajları Değiştirin.
   // ]; 
...
client.on('guildMemberAdd', member => {
  const embed = new Discord.RichEmbed()
    ...
    .addField('Sunucuna Beni Eklemek Mi İstiyorsun?', '/davet')
    .addField('Komutlarımı Öğrenmek Mi İstiyorsun?', '/yardım')
    .setFooter('Mystic, iyi eğlenceler diler!', client.user.avatarURL)
  member.send(embed);
});
